...
<h1 style="text-align: center; margin-top: 2em;">Votre message ne peut être accepté \nLes mots suivants ne sont p:</h1>`   
  // Fade message in
...
<h1 style="text-align: center;
    margin-top: 2em;">Merci pour votre message ! Il apparaitra prochainement.</h1> `   
...
subscribeForm.innerHTML = ` <h1>Ecrire un message dans le livre d'or</h1>
		<a class="close" href="#">&times;</a>
		<div class="content">
      <label style="display: block;
    text-align: center;" class="aterisk_before" for="gform"> Indique un champ obligatoire</label>
      <br>
    ...
    <form name="gform" id="gform" enctype="text/plain" action="${Google_Form_Link}" target="hidden_iframe">
       ...
       <label for="${GOOGLE_ENTRY_ID_Name}"  class="aterisk_after">Name </label>
        ...
        <input class="form-element short" type="text" name="${GOOGLE_ENTRY_ID_Name}" id="${GOOGLE_ENTRY_ID_Name}" placeholder="Votre nom" style="background: #5EC6C8;" required>
      
        <label for="${GOOGLE_ENTRY_ID_Email}">Votre email</label>
  ...
  oninput="this.setCustomValidity('')"  maxlength="50" placeholder="Entrez votre message ici" required></textarea>
   ...
   <div class="g-recaptcha"
       data-sitekey="${CaptchaKey}"></div> 
        ...
        <input class="form-button" type="reset" value="Réinitialiser">
